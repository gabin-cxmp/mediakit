...
export const generateImage = async (format, logoImg, standLetter, standNumber) => {
    ...
    highResCtx.fillText(`${standLetter.toUpperCase()}. ${standNumber}`, format.standLetterPosition[0] * scaleFactor, format.standLetterPosition[1] * scaleFactor);
    ...
    return { imageURL, fileName: `Customized Logo PC25 ${format.nameEN}.png` };
  };
