...
export const SOCIALS = [
 ...
 export const FORMATS_CUSTOMIZED_BANNERS = [
    { 
      ...
      standLetterPosition: [793.18, 1037], 
      maxLogoSize: [220, 124], 
    ...
    { 
      ...
      standLetterPosition: [795.15, 1874], 
      maxLogoSize: [220, 124], 
      font: '88px CA Mechano' 
    },
    { 
      ...
      standLetterPosition: [795.71, 1305], 
      maxLogoSize: [220, 124], 
      font: '88px CA Mechano' 
    },
    { 
      ...
      standLetterPosition: [1385.68, 333.98], 
      maxLogoSize: [167, 124], 
    ...
    { 
      ...
      standLetterPosition: [529.89, 118.72], 
    ...
    { 
      ...
      standLetterPosition: [219.61, 237.28], 
    ...
    { 
      ...
      standLetterPosition: [811.75, 591.05], 
